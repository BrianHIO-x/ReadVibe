...
void main() {
  ...
  group('txt parser', () {
    ...
    test('encodings detected', () {
      expect(
        decodeTxtBytes([0xEF, 0xBB, 0xBF, ...utf8.encode('汉字')]),
        '汉字',
      );
...
<body><p>前面<b>加粗</b>后面<i>斜体</i>结束。</p></body></html>'''));
      ...
      expect(
        book.chapters[1].epubBlocks.where((b) => b.isText).length,
        2,
      );
